...
public class CreateStoryActivity extends StoryActivityBase {
	...
	private void launchCameraIntent() {
		...
		values.put(MediaStore.Images.Media.TITLE, fileImage.getName());

		Uri cameraImageURI = getContentResolver().insert(
				MediaStore.Images.Media.EXTERNAL_CONTENT_URI, values);
		fragment.imagePath = cameraImageURI;

		// TODO - Add the filename to the Intent as an extra. Use the
		// Intent-extra name
		// from the MediaStore class, EXTRA_OUTPUT
		mIntent.putExtra(MediaStore.EXTRA_OUTPUT, cameraImageURI);
		mIntent.putExtra("filename", cameraImageURI);
	...
	private void launchVideoCameraIntent() {
		...
		ContentValues values = new ContentValues();
		values.put(MediaStore.Video.Media.TITLE, fileVideo.getName());

		Uri cameraVideoURI = getContentResolver().insert(
				MediaStore.Video.Media.EXTERNAL_CONTENT_URI, values);

		// TODO - Add the filename to the Intent as an extra. Use the
		// Intent-extra name
		// from the MediaStore class, EXTRA_OUTPUT
		mIntent.putExtra(MediaStore.EXTRA_OUTPUT, cameraVideoURI);
		...
		startActivityForResult(mIntent, CAMERA_VIDEO_REQUEST);
