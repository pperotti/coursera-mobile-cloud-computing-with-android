...
public class CreateStoryActivity extends StoryActivityBase {
	...
	private void launchSoundIntent() {
		...
		fragment.audioPath = audioFile.getAbsolutePath();
		...
		// the request code MIC_SOUND_REQUEST
	...
	private void launchCameraIntent() {
		...
		// function getOutputMediaFile to create a new filename for this
		// specific image;
		...
		// TODO - Start a new activity for result, using the new intent and
		// the request code CAMERA_PIC_REQUEST
